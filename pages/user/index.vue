<template>
  ...
  <LazyPopupMini :type="'delete'" :show="delete_box" :data="delete_data" :fnClose="toggleDeleteBox" :fnConfirm="confirmed_delete" />
  <LazyFormsUser :show="forms_user_show" :fnClose="()=>{forms_user_show=false}" :id="forms_user_id" :p_data="users" :is_copy="forms_user_copy"/>
  <LazyGAQR :show="qr_popup" :fnClose="()=>{qr_popup=false}" :qrCodeUrl="qr_img"/>

            ...
            <div class="w-full flex flex-row flex-wrap">
              ...
              <div class="w-full flex">
                <div class="p-1 w-full sm:w-full md:w-1/2 md:overflow-auto max-h-full">
                  <AttachmentSingleV1  :label="'Attachment'" :key="extra_money_trx.attachment_1_preview" :show="show" :link="extra_money_trx.attachment_1_preview" />
                  
                </div>
  
                <div class="p-1 w-full sm:w-full md:w-1/2 md:overflow-auto max-h-full">
                  <AttachmentSingleV1  :label="'Attachment'" :key="extra_money_trx.attachment_2_preview" :show="show" :link="extra_money_trx.attachment_2_preview" />

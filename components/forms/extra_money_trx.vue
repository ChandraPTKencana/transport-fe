        ...
        <div class="w-full flex flex-col items-center grow overflow-auto">
          <div class="w-full flex flex-row flex-wrap">
            ...
            <div class="p-1 w-full sm:w-full md:w-1/2 md:overflow-auto max-h-full">
              <AttachmentSingleV1 :label="'Attachment'" :link="extra_money_trx.attachment_1_preview" :blob_file="extra_money_trx.attachment_1" @setFile="extra_money_trx.attachment_1=$event" :show="show"  @setPreview="extra_money_trx.attachment_1_preview=$event" :can_remove="!disabled" :disabled="disabled"/>
              <p class="text-red-500">{{ field_errors.attachment_1 }}</p>
            </div>

            <div class="p-1 w-full sm:w-full md:w-1/2 md:overflow-auto max-h-full">
              <AttachmentSingleV1 :label="'Attachment'" :link="extra_money_trx.attachment_2_preview" :blob_file="extra_money_trx.attachment_2" @setFile="extra_money_trx.attachment_2=$event" :show="show"  @setPreview="extra_money_trx.attachment_2_preview=$event" :can_remove="true"/>
